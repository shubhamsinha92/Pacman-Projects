...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        #counter[position] = probability
        inf = float("infinity")
        v = inf
        ghostPosition = None
        for counter in livingGhostPositionDistributions:
            probablePosition = counter.sortedKeys()[0]
            print "probablePosition:", probablePosition
            ghostDistance = self.distancer.getDistance(pacmanPosition, probablePosition)
            print "ghostDistance:", ghostDistance
            if ghostDistance < v:
                v = ghostDistance
                print "v:", v
                ghostPosition = probablePosition
        ...
        for legalAction in legal:
            ...
            print "successorPosition:", successorPosition
            actionDistance = self.distancer.getDistance(ghostPosition, successorPosition)
            print "actionDistance:", actionDistance
            if actionDistance < v2:
                v2 = actionDistance
                print "v2:", v2
